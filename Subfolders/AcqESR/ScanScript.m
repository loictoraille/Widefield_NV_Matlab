...
tic
startTime = datetime('now'); % Capture l'heure de d�part

if RANDOM == 1  
    disp('Mode random freq: longer pause after generator instruction to account for longer time to reach frequency target');
end     

NPerm = 1; % d�coupage de la Width_MHz totale en segments pour �viter des �carts de fr�quence trop grands entre les pics, utile quand random
...
elapsedTime = endTime - startTime; % Calcule la dur�e �coul�e
