...
%             lineh = min(lineh);           %Lets just use one line.  This was probably added first
        ...
        %%%Remplace par Thomas Plisson 15/10/2018
        th1 = text(0.01,0.95,textstring1,'FontSize',8,'Tag','CursorText','Units','Normalized','Parent',axh);
        th2 = text(0.95,0.95,textstring2,'FontSize',8,'Tag','CursorText','Units','Normalized','Parent',axh);
