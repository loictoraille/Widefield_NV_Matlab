...
% VISA_Instrument This class defines instrument remote-control connection over VISA.NET. Version 1.6.0
...
% - first version created
    ...
    properties
        ...
        SessionClass % Type of the session (INSTR, HISLIP, SOCKET, GPIB)
    end
